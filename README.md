Planning of Work :
- 1.Start With finding asset of simple asset for 2d side scrolling
- 2.Make a movement and character first 
- 3.Make time hop system finish
- 4.Make inventory system 
- 5.Make craft system (because we have inventory system to reserve this system)
- 6.The last combat (cause this one was the biggest one system in my opinion)
- In Every System i will find asset for that system
Planing will do step 1-3 (Movement and Timehop)in Day 1
step 4-5 in Day 2 (Inventory and Crafting)
